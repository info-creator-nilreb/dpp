      ...
      <div style={{
        ...
        <button
          ...
          style={{
            ...
            border: "none",
            borderBottom: activeTab === "users" ? "2px solid #E20074" : "2px solid transparent",
            color: activeTab === "users" ? "#E20074" : "#7A7A7A",
            fontSize: "0.95rem",
        ...
        <button
          ...
          style={{
            ...
            backgroundColor: "transparent",
            border: "none",
            borderBottom: activeTab === "invitations" ? "2px solid #E20074" : "2px solid transparent",
            color: activeTab === "invitations" ? "#E20074" : "#7A7A7A",
            fontSize: "0.95rem",
        ...
        <button
          ...
          style={{
            ...
            backgroundColor: "transparent",
            border: "none",
            borderBottom: activeTab === "join-requests" ? "2px solid #E20074" : "2px solid transparent",
            color: activeTab === "join-requests" ? "#E20074" : "#7A7A7A",
            fontSize: "0.95rem",
            ...
            <div>
              <div style={{
                ...
                <button
                  ...
                  style={{
                    padding: "0.75rem 1.5rem",
                    backgroundColor: inviting ? "#CDCDCD" : "#E20074",
                    color: "#FFFFFF",
                    border: "none",
                    borderRadius: "6px",
                    fontSize: "1rem",
