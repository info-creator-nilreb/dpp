-- Migration: Add missing tables (feature_registry, block_types, dpp_content)
-- Diese Migration stellt sicher, dass die drei fehlenden Tabellen in der Produktionsdatenbank erstellt werden
-- WICHTIG: Keine Daten werden migriert, nur die Tabellenstruktur wird erstellt
