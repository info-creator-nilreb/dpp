...
-- Note: We do NOT make these fields NOT NULL because:
-- 1. Existing DPPs may not have template bindings
-- 2. New DPPs will have these set during creation
-- 3. Migration logic can backfill these fields if needed
